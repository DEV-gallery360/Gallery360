!function(e, t) {
    ...
    function U(e, t) {
        ...
        R[t] = R[t] || function(s) {
            ...
            for (e = 0,
            i = r.length; e < i; e++)
                W[r[e]] ? r[e] = W[r[e]] : r[e] = (t = r[e]).match(/\[[\s\S]/) ? t.replace(/^\[|\]$/g, "") : t.replace(/\\/g, "");
            return function(e) {
                var t, n = "";
                for (t = 0; t < i; t++)
                    n += O(r[t]) ? r[t].call(e, s) : r[t];
                return n
            }
        }(t),
    ...
    function Ee(e, t, n, s, i) {
        ...
        return a = o <= 0 ? Fe(r = e - 1) + o : o > Fe(e) ? (r = e + 1,
        o - Fe(e)) : (r = e,
        o),
        {
            year: r,
    ...
    function Ot(e) {
        if (e._f !== f.ISO_8601)
            if (e._f !== f.RFC_2822) {
                ...
                for (s = H(e._f, e._locale).match(N) || [],
                t = 0; t < s.length; t++)
                    i = s[t],
                    (n = (h.match(fe(i, e)) || [])[0]) && (0 < (r = h.substr(0, h.indexOf(n))).length && y(e).unusedInput.push(r),
                    h = h.slice(h.indexOf(n) + n.length),
                    c += n.length),
                    W[i] ? (n ? y(e).empty = !1 : y(e).unusedTokens.push(i),
                    o = i,
                    l = e,
                    null != (u = n) && m(_e, o) && _e[o](u, l._a, l, o)) : e._strict && !n && y(e).unusedTokens.push(i);
