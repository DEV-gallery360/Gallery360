...
//		});
	...
	//	}		
		...
		html += "<div class='group_section'>";
		html += "	<div class='group_header type3 fixheight_m'>";
		html += "		<h3>(선택)수상 경력 (편집 후 Drag&Drop으로 순서를 변경 하실 수 있습니다.)</h3>";
	...
	//	}
		...
		html += "<div class='group_section'>";
		html += "	<div class='group_header type3 fixheight_m'>";
		html += "		<h3>(선택)작품 소장처  (편집 후 Drag&Drop으로 순서를 변경 하실 수 있습니다.)</h3>";
	...
	//	}
		...
		html += "<div class='group_section'>";
		html += "	<div class='group_header type3 fixheight_m'>";
		html += "		<h3>(선택)전시 및 프로젝트 경력  (편집 후 Drag&Drop으로 순서를 변경 하실 수 있습니다.)</h3>";
	...
	"edit_group" : function(){
		...
		html += "	<button class='btn btn_gray btn_cancel' onclick=\'gPPF_Rental.load_career_list();\'>취소</button>";
...
//			html += "							</tr>";
	...
	//	html += "				<button class='btn btn_gray' id='artist_list' onclick=\"gPPF_Rental.save_artist_info_list();return false\">목록</button>";
		...
		html += "					<tr>";
		html += "						<th>";
		html += "							<span id='btn_profile_list_info' class='t_info_sh'>작가 사진<button class='btn btn_info_sh'>정보</button></span>";
		html += "							<div id='layer_profile_list_info' class='img_reginfo_sh' style='display:none;'>";
		html += "								<div>";
		html += "									<p><strong>'대관페이지'</strong> 접속시 노출되는 작가 사진 입니다.</p>";
		...
		html += "								작가 사진 최적 사이즈는 200px * 200px 입니다.";
		html += "							</p>";
		html += "						</td>";
		html += "					</tr>";
